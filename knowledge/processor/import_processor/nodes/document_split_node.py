...
if __name__ == '__main__':
    ...
    md_path = r"D:\code\python\shopkeeeper\knowledge\processor\import_processor\output_dir\华为擎云 G540 用户指南-(YTFZ,Windows11_03,zh-cn)\华为擎云 G540 用户指南-(YTFZ,Windows11_03,zh-cn)_new.md"

    with open(md_path, "r", encoding="utf-8") as f:
        md_content = f.read()

    init_state = {
        "md_path":r"D:\code\python\shopkeeeper\knowledge\processor\import_processor\output_dir\华为擎云 G540 用户指南-(YTFZ,Windows11_03,zh-cn)\华为擎云 G540 用户指南-(YTFZ,Windows11_03,zh-cn).md",
        "md_content": md_content,
        "file_title": "华为擎云 G540 用户指南-(YTFZ,Windows11_03,zh-cn)",
        "file_dir": r"D:\code\python\shopkeeeper\knowledge\processor\import_processor\output_dir"
    }
