...
if __name__ == '__main__':
    #1. 创建graph
    state = {
        "import_file_path":r"D:\code\python\shopkeeeper\knowledge\processor\import_processor\input_dir\HUAWEI MateStation B515 用户手册-(PanguL,Windows11_02,zh-cn).pdf",
